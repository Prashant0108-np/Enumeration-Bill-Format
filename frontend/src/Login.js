        ...
        try {
            ...
            if (userData.role === "user") {
                ...
                try {
                    ...
                    const res = await axios.get("https://enumeration-bill-format.onrender.com/api/exam-bill/user/", {
                    ...
                    if (typeof serverMsg === 'string' && serverMsg.includes('Token used too early')) {
                        try {
                            ...
                            const res2 = await axios.get("https://enumeration-bill-format.onrender.com/api/exam-bill/user/", {
